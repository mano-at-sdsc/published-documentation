...
**anatomy** | | A valid UBERON term [part 3 of 3-component composite primary key] | Required |  string | [UBERON lookup service](https://www.ebi.ac.uk/ols/ontologies/uberon) <br/> Example: `UBERON:0006956`