...
- C2M2 Table Guide
  - [Table Summary](./C2M2-Table-Summary)
    ...
    - [collection_anatomy.tsv](./TableInfo:-collection_anatomy.tsv)
    - [collection_compound.tsv](./TableInfo:-collection_compound.tsv)
    ...
    - [collection_gene.tsv](./TableInfo:-collection_gene.tsv)
    ...
    - [collection_protein.tsv](./TableInfo:-collection_protein.tsv)
    - [collection_substance.tsv](./TableInfo:-collection_substance.tsv)
    - [collection_taxonomy.tsv](./TableInfo:-collection_taxonomy.tsv)
    ...
    - [protein.tsv](./TableInfo:-protein.tsv)
    - [protein_gene.tsv](./TableInfo:-protein_gene.tsv)
