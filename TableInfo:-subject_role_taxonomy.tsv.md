...
**role_id** | A CFDE CV term categorizing the role assigned to this organism-level constituent component of this subject | Required | enum of strings | [Table of allowed values](https://osf.io/fapnr/)
