...
**association_type** | An indicator distinguishing "disease detected" from "disease ruled out" | Required | one of `cfde_disease_association_type:0` or `cfde_disease_association_type:1` | `cfde_disease_association_type:0`: "not observed" <br>`cfde_disease_association_type:1`: "observed"