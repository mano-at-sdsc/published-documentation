...
**association_type** | An indicator distinguishing "disease detected" from "disease ruled out" | Required | one of `cfde_disease_association_type:0`<br>"not observed"<br>or<br>`cfde_disease_association_type:1`<br>"observed" | 