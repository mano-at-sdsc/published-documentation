...
**association_type** | An indicator distinguishing "phenotype present" from "phenotype ruled out" [part 3 of 4-component composite primary key] | Required | one of `cfde_phenotype_association_type:0`<br>(meaning "phenotype ruled out")<br>or<br>`cfde_phenotype_association_type:1`<br>(meaning "phenotype observed") | 
**phenotype** | A valid Human Phenotype Ontology term [part 4 of 4-component composite primary key] | Required | string | [Human Phenotype Ontology lookup](https://hpo.jax.org/app/) <br /> Examples: `HP:0000349`, `HP:0012425`